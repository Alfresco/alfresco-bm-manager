...
public class ResultDataTest {
	...
	public void testDescriptionRuntime() throws BenchmarkResultException {
		...
		RuntimeResultData data2 = new RuntimeResultData(1, "",ResultOperation.None);
	...
	public void testDescriptionObjects1() throws BenchmarkResultException {
		...
		ObjectsResultData data2 = new ObjectsResultData(1, type, "",ResultOperation.None);
	...
	public void testResultOperation3() throws BenchmarkResultException {
		ResultObjectType type = ResultObjectType.Folder;
		ObjectsPerSecondResultData data1 = new ObjectsPerSecondResultData(1, type, getJsonValue(),ResultOperation.Unchanged);
		ObjectsPerSecondResultData data2 = new ObjectsPerSecondResultData(1, type, getJsonValue(),ResultOperation.Created);
